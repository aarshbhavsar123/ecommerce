        ...
        return (
            ...
            <Grid container spacing={6} alignItems="center">
                ...
                <Typography variant="h4" sx={{ fontWeight: "bold", fontSize: { xs: "1.8rem", md: "2.5rem" } }} gutterBottom>
                    {product && product.product_name}
                </Typography>

                <Typography variant="h5" sx={{ fontSize: { xs: "1.5rem", md: "2rem" }, color: "primary" }} gutterBottom>
                ...
                <Typography variant="body1" color="textSecondary" paragraph sx={{ typography: { xs: "body2", md: "body1" } }}>
